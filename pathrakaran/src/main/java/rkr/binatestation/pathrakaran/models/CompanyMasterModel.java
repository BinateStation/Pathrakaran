...
import static rkr.binatestation.pathrakaran.database.PathrakaranContract.CompanyMasterTable.COLUMN_COMPANY_ID;
import static rkr.binatestation.pathrakaran.database.PathrakaranContract.CompanyMasterTable.COLUMN_COMPANY_LOGO;
import static rkr.binatestation.pathrakaran.database.PathrakaranContract.CompanyMasterTable.COLUMN_COMPANY_NAME;
import static rkr.binatestation.pathrakaran.database.PathrakaranContract.CompanyMasterTable.COLUMN_COMPANY_STATUS;
import static rkr.binatestation.pathrakaran.database.PathrakaranContract.CompanyMasterTable.CONTENT_URI;
import static rkr.binatestation.pathrakaran.utils.Constants.KEY_JSON_COMPANY_ID;
import static rkr.binatestation.pathrakaran.utils.Constants.KEY_JSON_COMPANY_NAME;
import static rkr.binatestation.pathrakaran.utils.Constants.KEY_JSON_COMPANY_STATUS;
